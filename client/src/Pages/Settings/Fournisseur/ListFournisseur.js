...
function ListFournisseur() {
  document.title = "Liste des fournisseurs";
  ...
  function changeEtat(id,e) {
    dispatch(fournisseurChangerEtat( id )).then(e1=>{
      getFournisseur();
      switch(e){
        case 0: notify("tr", "Fournisseur activer avec succes", "success");break; 
        case 1:notify("tr", "Fournisseur désactiver avec succes", "success");break;
        default:break;
      }  
    }); 
  }
  ...
  useEffect(() => {
    verifToken();
    getFournisseur()
  }, [getFournisseur,verifToken]) //now shut up eslint
  return (
    <>
      <Container fluid>
                        ...
                        <div className="actions-right block_action">
                          <Button
                            onClick={() => {
                              ...
                              /* window.location.replace("/fournisseur/update/" + cell.row.values.id); */
                            }}
                            variant="warning"
                            size="sm"
